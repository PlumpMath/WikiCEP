...
$.extend( $.validator, {
	...
	messages: {
		...
		equalTo: "Por favor vuelva a ingresar el valor.",
		maxlength: $.validator.format( "Ingrese no mas de {0} caracteres." ),
		minlength: $.validator.format( "Ingrese por lo menos {0} caracteres." ),
		rangelength: $.validator.format( "Ingrese un valor que tenga entre {0} y {1} caracteres de largo." ),
		...
		step: $.validator.format( "Ingrese un multiplo de {0}." )
	},
